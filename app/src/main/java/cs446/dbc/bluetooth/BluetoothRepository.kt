...
class BluetoothRepository(private val app: Application) {
    ...
    private val _bluetoothDiscoverable =
        MutableStateFlow<Boolean>(if (checkPermissions()) ((bluetoothAdapter?.scanMode ?: -1)== BluetoothAdapter.SCAN_MODE_CONNECTABLE_DISCOVERABLE) else false)
