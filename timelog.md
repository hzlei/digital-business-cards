...
| 2024/03/02 | 0 | 9 | 0 | 0 | 0 | 5 | Initial file storage setup and testing |
...
| 2024/03/26 | 5 | 0 | 0 | 0 | 0 | 0 | Working on business card creation functionality code |
...
| 2024/03/31 | 0 | 0 | 0 | 0 | 8 | 0 | Implement card creation screen + enforce mandatory fields and image upload handling |
...
| 2024/03/30 | 0 | 3 | 0 | 0 | 0 | 0 | Created Business Card Creation Screen + data handling |
| 2024/03/31 | 0 | 1 | 0 | 0 | 0 | 0 | Fixed join event dialog rendering, and BusinessCardMultiSelect |
| 2024/03/31 | 0 | 0 | 0 | 0 | 5 | 0 | Worked on adjusting interaction in My Cards / Shared Cards screen, adding and implementing calls to view model to add / remove / edit business cards |
...
| 2024/04/02 | 0 | 9 | 0 | 0 | 6 | 0 | Fixed bug with server errors for event hosting and event joining. Fixed bug with image upload and download. Added image upload and download for QR codes to fix card transfer issue. Fixed race condition with event rendering vs server checks, and did a ton of code cleanup, error checking, end-to-end testing|
