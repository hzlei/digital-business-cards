...
| 2024/03/22 | 2 | 0 | 2 | 0 | 0 | 3 | Deliverable 4 Content |
...
| 2024/04/02 | 0 | 9 | 0 | 0 | 0 | 0 | Fixed bug with server errors for event hosting and event joining. Fixed bug with image upload and download. Added image upload and download for QR codes to fix card transfer issue. Fixed race condition with event rendering vs server checks, and did a ton of code cleanup, error checking, end-to-end testing|
