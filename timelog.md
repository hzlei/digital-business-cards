...
| 2024/03/28 | 0 | 5 | 0 | 0 | 0 | 0 | Implemented saving for created/edited events via FAB (still some bugs), added error handling, created datepickerdialog (still some bugs that need to be ironed out), added observable for form modification for create event, added overflow handling, and a few general UI changes |
