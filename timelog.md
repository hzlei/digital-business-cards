...
| 2024/03/28 | 0 | 5 | 0 | 0 | 0 | 0 | Deliverable 5 - worked on the Decorator pattern explanation and figure |
...
| 2024/03/30 | 0 | 6 | 0 | 0 | 0 | 0 | Created join dialog, added card selection to event creation, fixed event creation bug with information copying. Created API functions to handle http requests, looked into websocket handling. | 
